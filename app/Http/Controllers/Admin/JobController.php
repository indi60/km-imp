...
class JobController extends Controller
{
    ...
    public function index()
    {
        ...
        $Jobs = Job::all();
        return view('admin.job.index', compact('Jobs', 'count_total_project', 'count_total_tiket'));
    }
    ...
    public function create()
    {
        $count_total_project = Project::all()->count();
        $count_total_tiket = Ticket::all()->count();
        return view('admin.job.create', compact('count_total_project', 'count_total_tiket'));
    }
    ...
    public function edit($id)
    {
        ...
        $count_total_tiket = Ticket::all()->count();
        $Jobs = Job::find($id);
        return view('admin.job.edit', compact('Jobs', 'count_total_project', 'count_total_tiket'));
    }
