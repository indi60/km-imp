...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        $Roles = Role::all();
        return view('admin.role.index', compact('Roles', 'count_total_project', 'count_total_tiket'));
    }
    ...
    public function create()
    {
        $count_total_project = Project::all()->count();
        $count_total_tiket = Ticket::all()->count();
        return view('admin.role.create' , compact('count_total_project', 'count_total_tiket'));
    }
    ...
    public function edit($id)
    {
        ...
        $count_total_tiket = Ticket::all()->count();
        $Roles = Role::find($id);
        return view('admin.role.edit', compact('Roles', 'count_total_project', 'count_total_tiket'));
    }
