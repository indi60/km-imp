...
class StatusController extends Controller
{
    ...
    public function index()
    {
        ...
        $Statuses = Status::all();
        return view('admin.status.index', compact('Statuses', 'count_total_project', 'count_total_tiket'));
    }
    ...
    public function create()
    {
        $count_total_project = Project::all()->count();
        $count_total_tiket = Ticket::all()->count();
        return view('admin.status.create', compact('count_total_project', 'count_total_tiket'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.status.edit', compact('Statuses', 'count_total_project', 'count_total_tiket'));
    }
