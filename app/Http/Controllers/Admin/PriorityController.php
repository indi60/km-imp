...
class PriorityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.priority.index', compact('Priorities', 'count_total_project', 'count_total_tiket'));
    }
    ...
    public function create()
    {
        $count_total_project = Project::all()->count();
        $count_total_tiket = Ticket::all()->count();
        return view('admin.priority.create', compact('count_total_project', 'count_total_tiket'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.priority.edit', compact('Priorities', 'count_total_project', 'count_total_tiket'));
    }
