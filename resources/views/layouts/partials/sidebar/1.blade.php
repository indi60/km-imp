...
<ul class="navbar-nav bg-gradient-white sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
            ...
            <img src="{{ (asset('assets/images/logo/manage.svg')) }}" width="30" class="img-fluid" alt="" srcset="">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ url('/project') }}">
            <img src="{{ (asset('assets/images/logo/project.svg')) }}" width="30" class="img-fluid" alt="" srcset="">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ url('/issue') }}">
            <img src="{{ (asset('assets/images/logo/issue.svg')) }}" width="30" class="img-fluid" alt="" srcset="">
