...
<ul class="navbar-nav bg-gradient-white sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center mt-5 mb-5" href="#">
        <img src="{{ (asset('images/logo/logo-sidebar.svg')) }}" width="100" height="100" alt="" srcset="">
    </a>

    <!-- Nav Item - Dashboard -->
    <li class="nav-item">
        <a class="nav-link" href="{{ url('/home') }}">
            <img src="{{ (asset('images/logo/home.svg')) }}" width="30" alt="" srcset="">
            <span class="ml-4" style="font-size: 17.5px"><b class="text-center">Home</b></span>
        </a>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
            ...
            <img src="{{ (asset('images/logo/manage.svg')) }}" width="30" alt="" srcset="">
            <span class="ml-4" style="font-size: 17.5px"><b>Manage</b></span>
        </a>
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ url('/manage-member') }}">
                    <img src="{{ (asset('images/logo/manage-member.svg')) }}" width="30" height="20" alt="" srcset="">
                    <span class="ml-1" style="font-size: 14px"><b>Member</b></span>
                </a>

                <a class="collapse-item" href="{{ url('/category-project') }}">
                    <img src="{{ (asset('images/logo/manage-project.svg')) }}" width="30" height="20" alt="" srcset="">
                    <span class="ml-1" style="font-size: 14px"><b>Kategori Project</b></span>
                </a>

                <a class="collapse-item" href="{{ url('/laporan') }}">
                    <img src="{{ (asset('images/logo/manage-issue.svg')) }}" width="30" height="20" alt="" srcset="">
                    <span class="ml-1" style="font-size: 14px"><b>Laporan</b></span>
                </a>

                <a class="collapse-item" href="{{ url('/setting') }}">
                    <img src="{{ (asset('images/logo/setting.svg')) }}" width="30" height="20" alt="" srcset="">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ url('/project') }}">
            <img src="{{ (asset('images/logo/project.svg')) }}" width="30" alt="" srcset="">
            <span class="ml-4" style="font-size: 17.5px"><b>Project</b></span>
        </a>
    </li>
    ...
    <!-- Nav Item - Tables -->
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/article') }}">
                <img src="{{ (asset('images/logo/explore.svg')) }}" width="30" alt="" srcset="">
                <span class="ml-4" style="font-size: 17.5px"><b>Explore</b></span>
            </a>
        </li>
    ...
    @if (auth()->user()->role_id == '1')
        ...
        {{-- <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#config" aria-expanded="true"
                ...
                <img src="{{ (asset('images/logo/setting.svg')) }}" width="30" alt="" srcset="">
                <span class="ml-4" style="font-size: 17.5px"><b>Configuration</b></span>
            </a>
    ...
    <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#profile" aria-expanded="true"
                ...
                <span class="ml-4" style="font-size: 17.5px"><b>{{ Auth::user()->name }}</b></span>
            </a>
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-between mt-auto" href="#">
        <img src="{{ (asset('images/logo/logo-footer.svg')) }}" width="115" height="115" alt="" srcset="">
    </a>
