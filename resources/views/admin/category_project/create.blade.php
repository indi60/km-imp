...
@section('title', 'Admin | Tambah Data Kategori Project')
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-center">Tambah Kategori Project</h6>
        </div>

        <div class="card-body">
            <form class=" form-signin" action="/category-project" method="POST">
                @csrf
    ...
    <a href="/category-project" class="text-danger float-right">
