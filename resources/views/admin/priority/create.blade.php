...
@section('title', 'Admin | Tambah Data Priority')
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-center">Tambah Priority</h6>
        </div>

        <div class="card-body">
            <form class=" form-signin" action="/priority" method="POST">
                @csrf

                <div class="form-group">
                    <label for="name">Nama Priority</label>
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                        placeholder="Masukan Nama Priority" name="name" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control colorpicker @error('color') is-invalid @enderror" id="color"
                        placeholder="Masukan Warna Priority" name="color" value="{{ old('color') }}">
                    @error('color')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
