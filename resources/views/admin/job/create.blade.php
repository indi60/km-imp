...
@section('title', 'Admin | Tambah Data Job')
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-center">Tambah Job</h6>
        </div>

        <div class="card-body">
            <form class=" form-signin" action="/job" method="POST">
                @csrf

                <div class="form-group">
                    <label for="name">Nama Job</label>
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                        placeholder="Masukan Nama Job" name="name" value="{{ old('name') }}">
                    @error('name')
